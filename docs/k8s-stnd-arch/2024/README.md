...
![2024 k8s thumbnail](img/2024-k8s-stnd-arch-thumbnail.png){: width="100%" height="100%"}</br>
...
**[오픈텔레메트리(OpenTelemetry)](https://opentelemetry.io)
...
#### 분산 트레이싱
**[예거(Jaeger)](https://github.com/jaegertracing/jaeger)
