...
## 표준 아키택처 선정 배경
2023년 쿠버네티스를 보다 원할하게 사용하기 위한 많은 제품들이 나와 있지만, 역설적으로 너무 많은 제품들이 있기 때문에 오히려 선정하기 어려움이 있습니다.</br>
...
그렇지만 만약 이미 잘 쓰고 있는 구성 및 제품들이 있다면, 해당 내용이 가장 나에게 좋은 선택지 입니다. </br>
따라서 현재 선정한 제품들은 쿠버네티스를 시작하는 분들은 위한 가이드 또는 새로운 영역을 구성 추가할때 참고할 수 있는 내용이라고 이해해 주시면 좋겠습니다. 
...
2023년 Best Practice적인 성격으로 쿠버네티스 구성을 고민하신다면, 현재의 구성이 큰 도움이 될 것이라고 생각합니다. 부디 이를 통해서 금년도 쿠버네티스로의 진입이 더욱 더 수월하셨으면 합니다.
