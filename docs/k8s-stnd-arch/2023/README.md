...
## 표준 아키택처 선정 배경
2023년 쿠버네티스를 보다 완전하게 구성하기 위한 많은 제품들이 나와 있지만, 역설적으로 이미 너무 많은 제품이 있기 때문에 오히려 선정하는데 어려움이 있습니다. 
![2022 cncf landscape](img/2022Nov20-landscape.cncf.io.png)
[그림 1] **2022년 11월 20일을 기준으로 CNCF에서 제공하는 제품들**
...
하지만 만약 Best Practice적인 성격으로 2023년에 구성을 고민하신다면, 현재의 [쿠버네티스 표준 구성](2023-k8s-stnd-arch.pdf)이 큰 도움이 될 것이라고 생각합니다. 부디 이를 통해서 금년도 쿠버네티스로의 진입이 더욱 더 수월하셨으면 합니다. 
